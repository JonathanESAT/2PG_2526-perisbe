...
class Texture : public virtual Referenced {
 public:
  ...
  //This function doesn't release the data:
  static const bool Load(const unsigned char* data, const unsigned int width,
                         const unsigned int height,
                         EDK::ref_ptr<Texture> *output_tex, 
                         EDK::Texture::Format format = EDK::Texture::F_RGBA);
