...
void InitScene() {
    ...
    {
        //Material settings:
        EDK::ref_ptr<EDK::MaterialBasic::MaterialBasicSettings> cube_mat_settings;
    ...
    EDK::ref_ptr<EDK::MaterialBasic::MaterialBasicSettings> monke_mat_settings;
    ...
    for (int i = 0; i < num_geos; i++)
    {
        ...
        monke_draw->set_material(cube_mat.get());
